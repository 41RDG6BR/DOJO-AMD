  ...
  function(
    ...
    ComboBox
      ...
      postCreate: function() {
        ...
        var states = [
          {nameStates:"Alabama", state:"AL"},
          {nameStates:"Alaska", state:"AK"},
          {nameStates:"American Samoa", state:"AS"},
          {nameStates:"Arizona", state:"AZ"},
          {nameStates:"Arkansas", state:"AR"},
          {nameStates:"Armed Forces Europe", state:"AE"},
          {nameStates:"Armed Forces Pacific", state:"AP"},
          {nameStates:"Armed Forces the Americas", state:"AA"},
          {nameStates:"California", state:"CA"},
          {nameStates:"Colorado", state:"CO"},
          {nameStates:"Connecticut", state:"CT"},
          {nameStates:"Delaware", state:"DE"},
          {nameStates:"District of Columbia", state:"DC"},
          {nameStates:"Federated States of Micronesia", state:"FM"},
          {nameStates:"Florida", state:"FL"},
          {nameStates:"Georgia", state:"GA"},
          {nameStates:"Guam", state:"GU"},
          {nameStates:"Hawaii", state:"HI"},
          {nameStates:"Idaho", state:"ID"},
          {nameStates:"Illinois", state:"IL"},
          {nameStates:"Indiana", state:"IN"},
          {nameStates:"Iowa", state:"IA"},
          {nameStates:"Kansas", state:"KS"},
          {nameStates:"Kentucky", state:"KY"},
          {nameStates:"Louisiana", state:"LA"},
          {nameStates:"Maine", state:"ME"},
          {nameStates:"Marshall Islands", state:"MH"},
          {nameStates:"Maryland", state:"MD"},
          {nameStates:"Massachusetts", state:"MA"},
          {nameStates:"Michigan", state:"MI"},
          {nameStates:"Minnesota", state:"MN"},
          {nameStates:"Mississippi", state:"MS"},
          {nameStates:"Missouri", state:"MO"},
          {nameStates:"Montana", state:"MT"},
          {nameStates:"Nebraska", state:"NE"},
          {nameStates:"Nevada", state:"NV"},
          {nameStates:"New Hampshire", state:"NH"},
          {nameStates:"New Jersey", state:"NJ"},
          {nameStates:"New Mexico", state:"NM"},
          {nameStates:"New York", state:"NY"},
          {nameStates:"North Carolina", state:"NC"},
          {nameStates:"North Dakota", state:"ND"},
          {nameStates:"Northern Mariana Islands", state:"MP"},
          {nameStates:"Ohio", state:"OH"},
          {nameStates:"Oklahoma", state:"OK"},
          {nameStates:"Oregon", state:"OR"},
          {nameStates:"Pennsylvania", state:"PA"},
          {nameStates:"Puerto Rico", state:"PR"},
          {nameStates:"Rhode Island", state:"RI"},
          {nameStates:"South Carolina", state:"SC"},
          {nameStates:"South Dakota", state:"SD"},
          {nameStates:"Tennessee", state:"TN"},
          {nameStates:"Texas", state:"TX"},
          {nameStates:"Utah", state:"UT"},
          {nameStates:"Vermont", state:"VT"},
          {nameStates: "Virgin Islands, U.S.",state:"VI"},
          {nameStates:"Virginia", state:"VA"},
          {nameStates:"Washington", state:"WA"},
          {nameStates:"West Virginia", state:"WV"},
          {nameStates:"Wisconsin", state:"WI"},
          {nameStates:"Wyoming", state:"WY"}
      ];
      ...
      var combobox = new ComboBox({
        ...
        onChange: function(city){
            ...
            this.state.set('value', this.item ? this.item.state : null);
        }
      });
  
      this.city.appendChild(combobox.domNode)
        ...
        var filteringSelect = new FilteringSelect({
          ...
          style: "width: 150px;",
          autoComplete: true,
          searchAttr: "nameStates",
          onChange: function(state){
            this.city.query.state = this.item.state || /.*/;
        }
        });
      this.state.appendChild(filteringSelect.domNode)
